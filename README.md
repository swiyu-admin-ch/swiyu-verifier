...
| ISSUER_PUBLIC_KEY_CACHE_TTL_MILLI | (Deprecated, now JWK_CACHE_TTL_MILLI) TTL in milliseconds how long a public key result should be cached                                                                                                                                          | int              | 3600000 (1h) |
| JWK_CACHE_TTL_MILLI | TTL in milliseconds how long a public key result should be cached                                                                                                                                          | int              | 3600000 (1h) |
