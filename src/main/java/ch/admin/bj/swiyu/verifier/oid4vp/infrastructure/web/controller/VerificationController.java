...
public class VerificationController {
    ...
    ResponseEntity<VerificationErrorResponseDto> handleVerificationException(VerificationException e) {
        ...
        log.warn(String.format("The received verification presentation could not be verified - caused by %s - %s: %s", error.error(), error.errorCode(), error.errorDescription()), e);
