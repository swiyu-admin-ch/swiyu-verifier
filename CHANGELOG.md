...
- Limited the number of vcs sent with the multiple flag to 0 as the flow is not fully supported yet. The verifier will reject the request if more than 1 vcs are sent.
