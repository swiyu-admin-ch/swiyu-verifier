...
class VerificationPresentationMapperTest {
    ...
    void toDcqlPresentation_whenVpTokenIsMap_thenConvertsSuccessfully() {
        ...
        union.setPresentation_submission(null);
    ...
    @Test
    void toDcqlPresentation_whenPresentationSubmissionPresent_thenThrows() {
        var union = new VerificationPresentationUnionDto();
        union.setVp_token(Map.of("my_credential", List.of("jwt-1")));
        union.setPresentation_submission("{\"id\":\"x\"}");
